...
namespace softaware.ViewPort.Uwp.UserInteraction
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Gets a resource loader for the message dialog translations.
        /// </summary>
        /// <returns>The resource loader.</returns>
        public ResourceLoader GetResourceLoader() => ResourceLoader.GetForViewIndependentUse("softaware.ViewPort.Uwp/Resources");
